...
class AppTheme {
  static ThemeData light = ThemeData(
    ...
    textSelectionTheme: TextSelectionThemeData(
      selectionHandleColor: AppColors.appRed,
      cursorColor: AppColors.appRed,
      selectionColor: AppColors.appRed,
    ),
  );
}
...
class AppColors {
  ...
  /// APP COLORS
  static Color appRed = HexColor('F15F5F');
  static Color appBlack = HexColor('0C0C25');
  static Color appBlue = HexColor('3D7AA7');
  static Color appWhite = HexColor('FAFAFA');
  static Color appYellow = HexColor('ffff00');
  static Color appGreen = HexColor('00FF00');
}
